...
HD_PWD='C:/src/verilog_ethernet_acq7/verilog_ethernet_acq7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga2.tcl -notrace

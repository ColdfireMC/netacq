...
HD_PWD='C:/src/verilog_ethernet_acq7/verilog_ethernet_acq7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga2.tcl
